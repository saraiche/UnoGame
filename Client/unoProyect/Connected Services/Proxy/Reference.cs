...
namespace unoProyect.Proxy {
    ...
    public interface IDataService {
        ...
        bool SearchUser(unoProyect.Proxy.DTOCredentials credentials);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDataService/SearchUser", ReplyAction="http://tempuri.org/IDataService/SearchUserResponse")]
        System.Threading.Tasks.Task<bool> SearchUserAsync(unoProyect.Proxy.DTOCredentials credentials);
    ...
    public partial class DataServiceClient : System.ServiceModel.ClientBase<unoProyect.Proxy.IDataService>, unoProyect.Proxy.IDataService {
        ...
        public bool SearchUser(unoProyect.Proxy.DTOCredentials credentials) {
            return base.Channel.SearchUser(credentials);
        }
        
        public System.Threading.Tasks.Task<bool> SearchUserAsync(unoProyect.Proxy.DTOCredentials credentials) {
    ...
    public interface IChatService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetPlayersByInvitationCode", ReplyAction="http://tempuri.org/IChatService/GetPlayersByInvitationCodeResponse")]
        string[] GetPlayersByInvitationCode(string invitationCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetPlayersByInvitationCode", ReplyAction="http://tempuri.org/IChatService/GetPlayersByInvitationCodeResponse")]
        System.Threading.Tasks.Task<string[]> GetPlayersByInvitationCodeAsync(string invitationCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/RequestOpenGame", ReplyAction="http://tempuri.org/IChatService/RequestOpenGameResponse")]
        void RequestOpenGame(string invitationCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/RequestOpenGame", ReplyAction="http://tempuri.org/IChatService/RequestOpenGameResponse")]
        System.Threading.Tasks.Task RequestOpenGameAsync(string invitationCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/PutCardInCenter", ReplyAction="http://tempuri.org/IChatService/PutCardInCenterResponse")]
        void PutCardInCenter(string invitationCode, string card);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/PutCardInCenter", ReplyAction="http://tempuri.org/IChatService/PutCardInCenterResponse")]
        System.Threading.Tasks.Task PutCardInCenterAsync(string invitationCode, string card);
    }
    ...
    public interface IChatServiceCallback {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IChatService/ReceiveCenter")]
        void ReceiveCenter(string center);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IChatService/OpenGame")]
    ...
    public partial class ChatServiceClient : System.ServiceModel.DuplexClientBase<unoProyect.Proxy.IChatService>, unoProyect.Proxy.IChatService {
        ...
        public string[] GetPlayersByInvitationCode(string invitationCode) {
            return base.Channel.GetPlayersByInvitationCode(invitationCode);
        }
        
        public System.Threading.Tasks.Task<string[]> GetPlayersByInvitationCodeAsync(string invitationCode) {
            return base.Channel.GetPlayersByInvitationCodeAsync(invitationCode);
        }
        
        public void RequestOpenGame(string invitationCode) {
            base.Channel.RequestOpenGame(invitationCode);
        }
        
        public System.Threading.Tasks.Task RequestOpenGameAsync(string invitationCode) {
            return base.Channel.RequestOpenGameAsync(invitationCode);
        }
        
        public void PutCardInCenter(string invitationCode, string card) {
            base.Channel.PutCardInCenter(invitationCode, card);
        }
        
        public System.Threading.Tasks.Task PutCardInCenterAsync(string invitationCode, string card) {
            return base.Channel.PutCardInCenterAsync(invitationCode, card);
        }
    }
}
